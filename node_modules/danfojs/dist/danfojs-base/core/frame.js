...
* ==========================================================================
*/
var browser_1 = require("../io/browser");
var node_1 = require("../io/node");
...
var plotting_1 = require("../plotting");
...
var DataFrame = /** @class */ (function (_super) {
    ...
    */
    ...
    DataFrame.prototype.groupby = function (col) {
        ...
        var colDtype = this.dtypes.filter(function (val, index) {
    ...
    */
    ...
    DataFrame.prototype.toCSV = function (options) {
        if (utils.isBrowserEnv()) {
            return (0, browser_1.toCSVBrowser)(this, options);
        }
        else {
    ...
    DataFrame.prototype.toJSON = function (options) {
        if (utils.isBrowserEnv()) {
            return (0, browser_1.toJSONBrowser)(this, options);
        }
        else {
    ...
    DataFrame.prototype.toExcel = function (options) {
        if (utils.isBrowserEnv()) {
            (0, browser_1.toExcelBrowser)(this, options);
        }
        else {
